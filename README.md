# GIS Map Management System (COMPE 399/499 Summer Practice)
...
- **Role-Based Access Control:** Role-specific boundaries and dynamic permissions for Managers and Regional Officers.
- **Backend Integration:** RESTful C# ASP.NET Core Web API with Entity Framework Core database integration.

##  Tech Stack
- **Frontend:** HTML5, CSS3, JavaScript (ES6+), Bootstrap 5, MapLibre GL JS
